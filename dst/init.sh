#!/bin/sh
# This script was stolen from upstream Alpine!
#
# It comes from [mkinitfs], which is released under Version 2 (only)
# of the GPL. Accordingly, this derivative work is also licensed under
# the GPLv2. Consult the LICENSE at the root of the source tree.
#
# [mkinitfs]: https://gitlab.alpinelinux.org/alpine/mkinitfs, 82002baf

# this is the init script version
VERSION=3.6.1-tempmon
SINGLEMODE=no
sysroot=/sysroot
